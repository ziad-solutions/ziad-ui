  ...
  <div>
      ...
      <div class="demo-step-container">
        ...
        <div class="demo-step-content">
          ...
          <template v-if="!finished">
            ...
            <div>
              <mu-button class="demo-step-button" round :disabled="activeStep === 0" @click="handlePrev"> Voltar
              </mu-button>
              <mu-button class="demo-step-button" round color="primary" @click="handleNext">
                {{activeStep === 2 ? 'Próximo' : 'Próximo'}} </mu-button>
            </div>
          </template>
        </div>
      </div>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td>linear</td>
          <td>whether is linear step set to false, will no longer control the completed and disabled properties of the
            <code>step</code> component</td>
          <td>Boolean</td>
          <td>—</td>
          <td>true</td>
        </tr>
        <tr>
          <td>orientation</td>
          <td>horizontal: horizon step navigation, vertical: vertical step navigation</td>
          <td>String</td>
          <td>—</td>
          <td>horizontal</td>
        </tr>
