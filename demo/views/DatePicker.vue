  ...
  <div>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td>display-color</td>
          <td>time display area background color</td>
          <td>String</td>
          <td>-</td>
          <td>-</td>
        </tr>
        <tr>
          <td>date</td>
          <td>select date, support <code>sync</code> modifier</td>
          <td>Date</td>
          <td>—</td>
          <td>new Date()</td>
        </tr>
        ...
        <tr>
          ...
          <td>date format object, used to change the display of different language environments</td>
          <td>Object</td>
          <td>—</td>
          <td>—</td>
        </tr>
        <tr>
          ...
          <td>which day as the beginning of the one week</td>
          <td>Number</td>
          <td>0-6</td>
          <td>0</td>
        </tr>
        ...
        <tr>
          <td>landscape</td>
          <td>whether horizontal screen display</td>
          <td>Boolean</td>
          <td>—</td>
          <td>false</td>
        </tr>
        <tr>
          <td>no-display</td>
          <td>whether the time display section does not exist</td>
          <td>Boolean</td>
          <td>—</td>
          <td>false</td>
        </tr>
        <tr>
          <td>should-disable-date</td>
          <td>function to determine whether a date is not available</td>
          <td>Function</td>
          <td>—</td>
          <td>—</td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td>change</td>
          <td>trigger when selection date changes</td>
          <td>(date)</td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td>day</td>
          <td>day button content</td>
          <td>{ date, selected, disabled, now }</td>
        </tr>
      </tbody>
    </table>
