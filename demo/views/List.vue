  ...
  <div>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td>textline</td>
          <td>number of rows, used to change the height of list items</td>
          <td>String</td>
          <td>two-line/three-line</td>
          <td>—</td>
        </tr>
        <tr>
          <td>dense</td>
          <td>whether it is an intensive list that will adjust the height of list items</td>
          <td>Boolean</td>
          <td>—</td>
          <td>—</td>
        </tr>
        <tr>
          <td>nested-indent</td>
          <td>whether the nested list has indentation distance</td>
          <td>Boolean</td>
          <td>—</td>
          <td>true</td>
        </tr>
        <tr>
          <td>toggle-nested</td>
          <td>whether to toggle the display/hide nested list</td>
          <td>Boolean</td>
          <td>—</td>
          <td>—</td>
        </tr>
        <tr>
          <td>toggle-nested-type</td>
          <td>toggle nested type</td>
          <td>String</td>
          <td>expand/popover</td>
          <td>—</td>
        </tr>
        <tr>
          <td>value</td>
          <td>needs to be used with the subcomponent <code>mu-list-item</code></td>
          <td>—</td>
          <td>—</td>
          <td>—</td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td>change</td>
          <td>when the list item is clicked, the <code>value</code> needs to be changed to trigger the event</td>
          <td>(value)</td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td>button</td>
          <td>whether list items can be clicked</td>
          <td>Boolean</td>
          <td>—</td>
          <td>—</td>
        </tr>
        <tr>
          <td>avatar</td>
          <td>whether to contain the <code>mu-avatar</code> component, to adjust the height of the list item accordingly
          </td>
          <td>Boolean</td>
          <td>—</td>
          <td>—</td>
        ...
        <tr>
          <td>nested</td>
          <td>whether to allow nested lists</td>
          <td>Boolean</td>
          <td>—</td>
          <td>—</td>
        </tr>
        <tr>
          <td>nested-list-class</td>
          <td>nested list style</td>
          <td>Boolean</td>
          <td>—</td>
          <td>—</td>
        </tr>
        <tr>
          <td>open</td>
          <td>whether to display nested list</td>
          <td>Boolean</td>
          <td>—</td>
          <td>true</td>
        </tr>
        <tr>
          <td>value</td>
          <td>when the value of the <code>value</code> and <code>mu-list</code> components are equal, the component
            rendering state is selected</td>
          <td>—</td>
          <td>—</td>
          <td>—</td>
        </tr>
