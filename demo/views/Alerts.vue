<template>
  <div>
    ...
    <h2>Display Icon and delete icon</h2>
    <div class="code">
      <mu-alert color="success">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td>delete</td>
          <td>determine whether it’s to display deleting icons</td>
          <td>Boolean</td>
          <td>—</td>
          <td>—</td>
        </tr>
        <tr>
          <td>transition</td>
          <td>setting the transition animation to display and hide the component</td>
          <td>String</td>
          <td>—</td>
          <td>—</td>
        </tr>
        <tr>
          <td>mode</td>
          <td>setting the mode of the transtion animation</td>
          <td>String</td>
          <td>out-in/in-out</td>
          <td>—</td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td>delete</td>
          <td>triggers when the delete icon clicked</td>
          <td>—</td>
        </tr>
      </tbody>
    </table>
